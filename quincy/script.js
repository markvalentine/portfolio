$(document).ready(function() {
    ...
    submitButton.click(function(event) {
        ...
        if (story.length != 0 || imageURL != null || audioURL != null) {
            ...
            window.location.href = "http://markvalentine.github.io/portfolio/quincy/memories";
        } else {
    ...
    function showDropdown() {
        $('.hamburger').after("<nav class=\"mobile\"><a href=\"http://markvalentine.github.io/portfolio/quincy\">Quincy</a><a href=\"http://markvalentine.github.io/portfolio/quincy/memories\">Memories</a><a href=\"http://markvalentine.github.io/portfolio/quincy/share\">Share a Memory</a></nav>");
        var nav = $('nav.mobile')
